...
-- ----------------------------
-- Table structure for wcs_stock_box_all
-- ----------------------------
DROP TABLE IF EXISTS `wcs_stock_box_all`;
CREATE TABLE `wcs_stock_box_all`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 22886 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WCS接口库存箱子（由接口1 JSON 落库）' ROW_FORMAT = Dynamic;
