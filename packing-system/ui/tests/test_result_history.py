...
def test_interface_history_prefers_execution_report_and_falls_back(tmp_path):
    ...
    base_success = output / "packing_plan_20260721_100000.json"
    execution = output / "packing_plan_20260721_100000_execution.json"
    base_fallback = output / "packing_plan_20260721_110000.json"
...
def test_latest_result_ignores_newer_wcs_artifacts(tmp_path):
    ...
    output = tmp_path / "packing-workspace" / "output"
    execution = output / "packing_plan_20260721_100000_execution.json"
    wcs_map = output / "packing_plan_20260721_100000_execution_wcs_map.json"
    _write_report(execution)
